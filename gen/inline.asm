...
00000000000011c9 <main>:
    ...
    11e4:	c7 45 f4 05 00 00 00 	mov    DWORD PTR [rbp-0xc],0x5
    11eb:	48 8d 45 f4          	lea    rax,[rbp-0xc]
    11ef:	48 89 c7             	mov    rdi,rax				#inc関数の引数をrdiに入れる。
    11f2:	e8 ca 00 00 00       	call   12c1 <_Z3incRi>			#インライン関数として定義したはずがincを普通に呼び出している。
    11f7:	89 c6                	mov    esi,eax	
    11f9:	48 8d 3d 40 2e 00 00 	lea    rdi,[rip+0x2e40]        # 4040 <_ZSt4cout@@GLIBCXX_3.4>
    1200:	e8 cb fe ff ff       	call   10d0 <_ZNSolsEi@plt>
    1205:	48 89 c2             	mov    rdx,rax
    1208:	48 8b 05 c1 2d 00 00 	mov    rax,QWORD PTR [rip+0x2dc1]        # 3fd0 <_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_@GLIBCXX_3.4>
    120f:	48 89 c6             	mov    rsi,rax
    1212:	48 89 d7             	mov    rdi,rdx
    1215:	e8 86 fe ff ff       	call   10a0 <_ZNSolsEPFRSoS_E@plt>
    121a:	8b 45 f4             	mov    eax,DWORD PTR [rbp-0xc]
    121d:	89 c6                	mov    esi,eax
    121f:	48 8d 3d 1a 2e 00 00 	lea    rdi,[rip+0x2e1a]        # 4040 <_ZSt4cout@@GLIBCXX_3.4>
    1226:	e8 a5 fe ff ff       	call   10d0 <_ZNSolsEi@plt>
    122b:	48 89 c2             	mov    rdx,rax
    122e:	48 8b 05 9b 2d 00 00 	mov    rax,QWORD PTR [rip+0x2d9b]        # 3fd0 <_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_@GLIBCXX_3.4>
    1235:	48 89 c6             	mov    rsi,rax
    1238:	48 89 d7             	mov    rdi,rdx
    123b:	e8 60 fe ff ff       	call   10a0 <_ZNSolsEPFRSoS_E@plt>
    1240:	b8 00 00 00 00       	mov    eax,0x0
    1245:	48 8b 4d f8          	mov    rcx,QWORD PTR [rbp-0x8]
    1249:	64 48 33 0c 25 28 00 	xor    rcx,QWORD PTR fs:0x28
    1250:	00 00 
    1252:	74 05                	je     1259 <main+0x90>
    1254:	e8 57 fe ff ff       	call   10b0 <__stack_chk_fail@plt>
    1259:	c9                   	leave  
    125a:	c3                   	ret    

000000000000125b <_Z41__static_initialization_and_destruction_0ii>:
    125b:	f3 0f 1e fa          	endbr64 
    125f:	55                   	push   rbp
    1260:	48 89 e5             	mov    rbp,rsp
    1263:	48 83 ec 10          	sub    rsp,0x10
    1267:	89 7d fc             	mov    DWORD PTR [rbp-0x4],edi
    126a:	89 75 f8             	mov    DWORD PTR [rbp-0x8],esi
    126d:	83 7d fc 01          	cmp    DWORD PTR [rbp-0x4],0x1
    1271:	75 32                	jne    12a5 <_Z41__static_initialization_and_destruction_0ii+0x4a>
    1273:	81 7d f8 ff ff 00 00 	cmp    DWORD PTR [rbp-0x8],0xffff
    127a:	75 29                	jne    12a5 <_Z41__static_initialization_and_destruction_0ii+0x4a>
    127c:	48 8d 3d ce 2e 00 00 	lea    rdi,[rip+0x2ece]        # 4151 <_ZStL8__ioinit>
    1283:	e8 38 fe ff ff       	call   10c0 <_ZNSt8ios_base4InitC1Ev@plt>
    1288:	48 8d 15 79 2d 00 00 	lea    rdx,[rip+0x2d79]        # 4008 <__dso_handle>
    128f:	48 8d 35 bb 2e 00 00 	lea    rsi,[rip+0x2ebb]        # 4151 <_ZStL8__ioinit>
    1296:	48 8b 05 5b 2d 00 00 	mov    rax,QWORD PTR [rip+0x2d5b]        # 3ff8 <_ZNSt8ios_base4InitD1Ev@GLIBCXX_3.4>
    129d:	48 89 c7             	mov    rdi,rax
    12a0:	e8 eb fd ff ff       	call   1090 <__cxa_atexit@plt>
    12a5:	90                   	nop
    12a6:	c9                   	leave  
    12a7:	c3                   	ret    

00000000000012a8 <_GLOBAL__sub_I_main>:
    12a8:	f3 0f 1e fa          	endbr64 
    12ac:	55                   	push   rbp
    12ad:	48 89 e5             	mov    rbp,rsp
    12b0:	be ff ff 00 00       	mov    esi,0xffff
    12b5:	bf 01 00 00 00       	mov    edi,0x1
    12ba:	e8 9c ff ff ff       	call   125b <_Z41__static_initialization_and_destruction_0ii>
    12bf:	5d                   	pop    rbp
    12c0:	c3                   	ret    

00000000000012c1 <_Z3incRi>:				#inc関数本体。ただ参照渡しされたものをインクリメントするだけなんだが
    12c1:	f3 0f 1e fa          	endbr64 
    12c5:	55                   	push   rbp
    12c6:	48 89 e5             	mov    rbp,rsp
    12c9:	48 89 7d f8          	mov    QWORD PTR [rbp-0x8],rdi
    12cd:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
    12d1:	8b 00                	mov    eax,DWORD PTR [rax]
    12d3:	8d 50 01             	lea    edx,[rax+0x1]
    12d6:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
    12da:	89 10                	mov    DWORD PTR [rax],edx
    12dc:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
    12e0:	8b 00                	mov    eax,DWORD PTR [rax]
    12e2:	5d                   	pop    rbp
    12e3:	c3                   	ret    
